...
opt -enable-new-pm=0 -load ${compilerpath}/build/lib/CudaHostTransform.so -S -o modif.ll  --debug-pass-manager main.ll

llc --relocation-model=pic -filetype=obj modif.ll

clang++ -L/usr/local/cuda-11.8/lib64 -lcudart -ldl -lrt -lpthread -lnvidia-ml modif.o  -o a.out
